...
func (Ch ChannelModel) GetFieldIdByGroupId(id int, DB *gorm.DB, tenantid string) (grpfield []TblGroupField, err error) {
...
func (Ch ChannelModel) DeleteEntryByChannelId(id int, DB *gorm.DB, tenantid string) error {
...
/*Delete Channel*/
func (Ch ChannelModel) DeleteFieldGroupById(tblfieldgrp *TblFieldGroup, id int, DB *gorm.DB, tenantid string) error {
...
func (Ch ChannelModel) GetAllField(DB *gorm.DB, tenantid string) (channel []TblFieldType, err error) {
...
func (Ch ChannelModel) UpdateFieldDetails(fds *TblField, id int, DB *gorm.DB, tenantid string) error {
...
func (Ch ChannelModel) CheckChannelCategoryAlreadyExitst(channelid int, categoryids string, DB *gorm.DB, tenantid string) error {
...
func (Ch ChannelModel) UpdateChannelNameInEntries(modper *permission.TblModulePermission, DB *gorm.DB, tenantid string) error {
...
/**/
func (Ch ChannelModel) GetChannelCategoryNotExist(category *[]tblchannelcategory, channelid int, categoryids []string, DB *gorm.DB, tenantid string) error {
...
func (Ch ChannelModel) DeleteChannelCategoryByValue(category *tblchannelcategory, id int, DB *gorm.DB, tenantid string) error {
...
/*Delete Field By Id*/
func (Ch ChannelModel) DeleteFieldById(field *TblField, id []int, DB *gorm.DB, tenantid string) error {
...
func (Ch ChannelModel) DeleteFieldOptionById(fieldopt *TblFieldOption, id []string, fid int, DB *gorm.DB, tenantid string) error {
...
/*Delete FieldOption By fieldid*/
func (Ch ChannelModel) DeleteOptionById(fieldopt *TblFieldOption, id []int, fid []int, DB *gorm.DB, tenantid string) error {
...
func (Ch ChannelModel) UpdateFieldOption(fdoption *TblFieldOption, id int, DB *gorm.DB, tenantid string) error {

	if err := DB.Table("tbl_field_options").Where("id=? and tenant_id=?", id, tenantid).UpdateColumns(map[string]interface{}{"option_name": fdoption.OptionName, "option_value": fdoption.OptionValue, "modified_on": fdoption.ModifiedOn, "modified_by": fdoption.ModifiedBy, "order_index": fdoption.OrderIndex}).Error; err != nil {
...
func (ch ChannelModel) GetPermissionChannel(channels *Channel, DB *gorm.DB, tenantid string) (channel []Tblchannel, err error) {

	query := DB.Table("tbl_channels").Where("is_deleted=0 and is_active=1 and tenant_id=?", tenantid).Order("id desc")
...
func (ch ChannelModel) ModulePermissionChannelDelete(routename string, DB *gorm.DB, tenantid string) error {
